! function(e, t) {
  ...
  return function(e) {
      ...
      S = function() {
        function e() {
          ...
          a(this, e), (0, b.default)(this, {
            ...
            boundSystem: {},
            toolbox: {}
          }, t), this.getSystem = this._getSystem.bind(this), this.store = p(T, (0, y.fromJS)(this.state), this.getSystem), this.buildSystem(!1), this.register(this.plugins)
        }
        return d(e, [{
          key: "getStore",
          value: function() {
      ...
      t.validateParam = function(e, t) {
        ...
        if ("number" === a) {
          ...
          s = e.getIn(["items", "type"]), n.forEach(function(e, t) {
            var n = void 0;
            "number" === s ? n = J(e) : "integer" === s && (n = V(e)), n && r.push({
              index: t,
              error: n
            })
          })
    ...
    var n = "\\ud800-\\udfff",
      ...
      D = I + N + U,
      B = "(?:" + [E, S, x].join("|") + ")" + D,
      F = RegExp([C + "?" + w + "+" + q + "(?=" + [b, C, "$"].join("|") + ")", k + "+" + M + "(?=" + [b, C + R, "$"].join("|") + ")", C + "?" + R + "+" + q, C + "+" + M, L, z, _, B].join("|"), "g");
    e.exports = r
  }, function(e, t, r) {
    function n(e, t) {
      ...
      p = t.sampleFromSchema = function e(t) {
        ...
        if ("object" === o) {
          ...
          if (s === !0) d.additionalProp1 = {};
            ...
            for (var y = (0, a.objectify)(s), m = e(y, {
                includeReadOnly: c
        ...
        return "array" === o ? [e(l, {
          includeReadOnly: c
        })] : t.enum ? t.default ? t.default : (0, a.normalizeArray)(t.enum)[0] : f(t)
      },
      ...
      j = t.operations = (0, f.createSelector)(w, function(e) {
        ...
        return e && e.forEach ? (e.forEach(function(e, r) {
          return e && e.forEach ? void e.forEach(function(e, n) {
            y.indexOf(n) !== -1 && (t = t.push((0, d.fromJS)({
              path: r,
              method: n,
              operation: e,
              id: n + "-" + r
    ...
    t.preAuthorizeImplicit = function(e) {
      ...
      return function(t) {
        var r = t.authActions,
          ...
          p = {},
          d = {};
        return "basic" === i ? d.Authorization = "Basic " + (0, c.btoa)(a + ":" + u) : (Object.assign(f, {
          username: a
        }, {
          password: u
        }), "query" === i ? (s && (p.client_id = s), l && (p.client_secret = l)) : Object.assign(f, {
          client_id: s
        }, {
          client_secret: l
        })), r.authorizeRequest({
      ...
      return function(t) {
        ...
        r.fetch({
          ...
          var t = JSON.parse(e.data),
            r = t && (t.error || ""),
            a = t && (t.parseError || "");
          return e.ok ? r || a ? void o.newAuthErr({
            authId: c,
            level: "error",
            source: "auth",
      ...
      c = function(e) {
        ...
        return u(t, e), i(t, [{
          ...
          value: function() {
            ...
            })), l.default.createElement(u, null, l.default.createElement("p", null, "Name: ", l.default.createElement("code", null, t.get("name")))), l.default.createElement(u, null, l.default.createElement("p", null, "In: ", l.default.createElement("code", null, t.get("in")))), l.default.createElement(u, null, l.default.createElement("label", null, "Value:"), p ? l.default.createElement("code", null, " ****** ") : l.default.createElement(i, null, l.default.createElement(a, {
              type: "text",
        ...
        return u(t, e), i(t, [{
          ...
          value: function() {
            ...
            return l.default.createElement("div", null, l.default.createElement("h4", null, "Basic authorization", l.default.createElement(c, {
              ...
              source: t.get("description")
            })), l.default.createElement(u, null, l.default.createElement("label", null, "Username:"), p ? l.default.createElement("code", null, " ", p, " ") : l.default.createElement(i, null, l.default.createElement(a, {
              type: "text",
              required: "required",
              name: "username",
              onChange: this.onChange
            }))), l.default.createElement(u, null, l.default.createElement("label", null, "Password:"), p ? l.default.createElement("code", null, " ****** ") : l.default.createElement(i, null, l.default.createElement(a, {
              required: "required",
        ...
        return i(t, e), s(t, [{
          ...
          value: function() {
            ...
            return c.default.createElement("div", null, c.default.createElement("h4", null, "OAuth2.0 ", c.default.createElement(v, {
              ...
              className: "flow"
            }, "Flow: ", c.default.createElement("code", null, r.get("flow"))), g !== y ? null : c.default.createElement(s, null, c.default.createElement(s, null, c.default.createElement("label", {
              htmlFor: "oauth_username"
            }, "username:"), w ? c.default.createElement("code", null, " ", this.state.username, " ") : c.default.createElement(l, {
              tablet: 10,
              desktop: 10
            ...
            }))), c.default.createElement(s, null, c.default.createElement("label", {
              htmlFor: "oauth_password"
            }, "password:"), w ? c.default.createElement("code", null, " ****** ") : c.default.createElement(l, {
              tablet: 10,
              desktop: 10
            }, c.default.createElement("input", {
              id: "oauth_password",
            ...
            }, "type:"), w ? c.default.createElement("code", null, " ", this.state.passwordType, " ") : c.default.createElement(l, {
              tablet: 10,
              desktop: 10
              ...
              value: "request-body"
            }, "Request body"), c.default.createElement("option", {
              value: "query"
            }, "Query parameters"))))), (g === m || g === d || g === h || g === y && "basic" !== this.state.passwordType) && (!w || w && this.state.clientId) && c.default.createElement(s, null, c.default.createElement("label", {
              htmlFor: "client_id"
            }, "client_id:"), w ? c.default.createElement("code", null, " ****** ") : c.default.createElement(l, {
              tablet: 10,
              desktop: 10
            }, c.default.createElement("input", {
              id: "client_id",
              ...
              "data-name": "clientId",
              onChange: this.onInputChange
            }))), (g === m || g === h || g === y && "basic" !== this.state.passwordType) && c.default.createElement(s, null, c.default.createElement("label", {
              htmlFor: "client_secret"
            }, "client_secret:"), w ? c.default.createElement("code", null, " ****** ") : c.default.createElement(l, {
              tablet: 10,
              desktop: 10
            }, c.default.createElement("input", {
              id: "client_secret",
    ...
    function o(e, t, r, n) {
      var o = e.schema,
        ...
        d = o.get("flow"),
        h = void 0;
      return "password" === d ? void t.authorizePassword(e) : "application" === d ? void t.authorizeApplication(e) : c ? ("implicit" !== d && "accessCode" !== d || (h = o.get("authorizationUrl") + "?response_type=" + ("implicit" === d ? "token" : "code")), h += "&redirect_uri=" + encodeURIComponent(c) + "&scope=" + encodeURIComponent(a.join(f)) + "&state=" + encodeURIComponent(p) + "&client_id=" + encodeURIComponent(l), u.default.swaggerUIRedirectOauth2 = {
        auth: e,
        state: p,
        callback: "implicit" === d ? t.preAuthorizeImplicit : t.authorizeAccessCode,
        errCb: r.newAuthErr
      }, void u.default.open(h)) : void r.newAuthErr({
        authId: s,
        source: "validation",
        level: "error",
      ...
      m = function(e) {
        ...
        return i(t, e), s(t, [{
          ...
          value: function() {
            ...
            }, c.default.createElement("span", null, n), c.default.createElement(k, {
              path: r
            })), u ? c.default.createElement("div", {
              className: "opblock-summary-description"
            }, b) : null, j && j.count() ? c.default.createElement(R, {
              authActions: m,
              security: j,
              authSelectors: v
    ...
    var m = function() {
      ...
      this.updateValues = function(t) {
        ...
        } else l ? e.onChange(e.sample("xml"), {
          isXml: l,
          isEditBox: a
        }) : e.onChange(e.sample(), {
          isEditBox: a
        ...
        return u(t, e), i(t, [{
          ...
          value: function() {
            var e = this.props,
              ...
              g = n("schemes"),
              _ = !t.specStr();
            return _ ? l.default.createElement("h4", null, "No spec provided.") : l.default.createElement("div", {
              className: "swagger-ui"
            }, l.default.createElement("div", null, l.default.createElement(b, null), l.default.createElement(m, {
              className: "information-container"
            }, l.default.createElement(v, {
              mobile: 12
            }, o.count() ? l.default.createElement(p, {
              info: o,
              url: a,
              host: i,
              basePath: u,
              externalDocs: c,
              getComponent: n
            }) : null)), f && f.size || s ? l.default.createElement("div", {
              className: "scheme-container"
            }, l.default.createElement(v, {
              className: "schemes wrapper",
              mobile: 12
            }, f && f.size ? l.default.createElement(g, {
              schemes: f,
              specActions: r
            }) : null, s ? l.default.createElement(y, null) : null)) : null, l.default.createElement(m, null, l.default.createElement(v, {
              mobile: 12,
              desktop: 12
            }, l.default.createElement(d, null))), l.default.createElement(m, null, l.default.createElement(v, {
              mobile: 12,
              desktop: 12
