! function(e, t) {
  ...
  return function(e) {
    ...
    e.exports = function(e, t) {
      ...
      function m(e) {
        function t(t, r, i, n, s) {
          for (var o = t[r], c = 0; c < e.length; c++)
            if (a(o, e[c])) return null;
    ...
    function P(e, t, r, i, n) {
      ...
      if (a && (a = m || n), 1 !== f && G !== r || (h = W === r || H === r ? t : t + 1, p = e.position - e.lineStart, 1 === f ? a && (F(e, p) || T(e, p, h)) || C(e, h) ? g = !0 : (o && S(e, h) || A(e, h) || k(e, h) ? g = !0 : I(e) ? (g = !0, null === e.tag && null === e.anchor || d(e, "alias node should not have any properties")) : w(e, h, W === r) && (g = !0, null === e.tag && (e.tag = "?")), null !== e.anchor && (e.anchorMap[e.anchor] = e.result)) : 0 === f && (g = a && F(e, p))), null !== e.tag && "!" !== e.tag)
        if ("?" === e.tag) {
    ...
    function k(e, t, r, i, n, s) {
      ...
      if (c && (a = e.duplicates.indexOf(r), u = a !== -1), (null !== e.tag && "?" !== e.tag || u || 2 !== e.indent && t > 0) && (n = !1), u && e.usedDuplicates[a]) e.dump = "*ref_" + a;
        ...
        if (c && u && !e.usedDuplicates[a] && (e.usedDuplicates[a] = !0), "[object Object]" === o) i && 0 !== Object.keys(e.dump).length ? (w(e, t, e.dump, n), u && (e.dump = "&ref_" + a + e.dump)) : (E(e, t, e.dump), u && (e.dump = "&ref_" + a + " " + e.dump));
